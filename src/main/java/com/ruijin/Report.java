...
import com.ruijin.specification.SpecYear2016;
...
public class Report {
    ...
    static {
        ...
        pepare("2016", pMeta, iMeta, dMetas, new SpecYear2016(), 0, 1, "C:\\Users\\Administrator\\Desktop\\2016年汇总.xlsx");
        ...
        pepare("2015", pMeta, iMeta, dMetas, new SpecYear2016(), 4, 5, "C:\\Users\\Administrator\\Desktop\\2015年汇总.xlsx");
        ...
        pepare("2014", pMeta, iMeta, dMetas, new SpecYear2016(), 4, 5, "C:\\Users\\Administrator\\Desktop\\2014全年.xlsx");
        ...
        pepare("2013", pMeta, iMeta, dMetas, new SpecYear2016(), 0, 1, "C:\\Users\\Administrator\\Desktop\\2013.xlsx");
   ...
   /* Pepare2015Meta pepare2015Meta = new Pepare2015Meta().invoke();
    ...
    public static void main(String args[])
        ...
        for (String year : years) {
            ...
            List<Patient> result = patientGenerator.makePatients(filePath, 0, yearToAddRow.get(year), yearToHeadRow.get(year), pMeta, iMeta, dMetas);

            List<Patient> filteredP = new ArrayList<Patient>();
            for (Patient p : result) {
                List<InspectInfo> inspectInfos = p.getInspectInfos();
                List<InspectInfo> newinspectInfos = new ArrayList<InspectInfo>();
                for (InspectInfo inspectInfo : inspectInfos) {
                    if ("肺炎克雷伯菌".equals(inspectInfo.getGrem())) {
            ...
            for (Patient eachP : filteredP) {
                System.out.println(eachP.getName());
    ...
    private static class Pepare2016Meta {
        ...
        public Pepare2016Meta invoke() {
            ...
            metas.addMeta(new Meta("isfast", Lists.newArrayList(54), Boolean.class, new BooleanConvert()));
    ...
    private static class Pepare2015Meta {
        ...
        public Pepare2015Meta invoke() {
            ...
            metas.addMeta(new Meta("isfast", Lists.newArrayList(37), Boolean.class, new BooleanConvert()));
            Metas metas1 = new Metas();
            metas1.addMeta(
    ...
    private static class Pepare2014Meta {
        ...
        public Pepare2014Meta invoke() {
            ...
            iMeta.add(new Meta("grem", Lists.newArrayList(18), String.class, new StringConvert()));
            iMeta.add(new Meta("inspectType", Lists.newArrayList(100), String.class, new StringConvert()));
            iMeta.add(new Meta("inspectDate", Lists.newArrayList(15), DateTime.class, new DateConvert()));
            iMeta.add(new Meta("position", Lists.newArrayList(16), String.class, new StringConvert()));
            ...
            metas.addMeta(new Meta("isfast", Lists.newArrayList(36), Boolean.class, new BooleanConvert()));
            Metas metas1 = new Metas();
            metas1.addMeta(
                    new Meta("drugName", Lists.newArrayList(1037), String.class, new StringConvert()));
            metas1
